...
**Do NOT use `lua auth key --force`** as the auth probe. It prints the raw credential to stdout, which would put the credential in the Codex conversation and model context.
